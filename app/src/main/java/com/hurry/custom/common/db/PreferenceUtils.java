...
public class PreferenceUtils {
	...
	public static void setLogIn(Context context){
		getSharedPreferences(context).edit().putBoolean("LOGIN_APP_CUSTOMER", true).commit();
	}
	public static void setLogOut(Context context){
		getSharedPreferences(context).edit().putBoolean("LOGIN_APP_CUSTOMER", false).commit();
	}
	...
	public static boolean getLogin(Context context) {
		boolean userLogin = getSharedPreferences(context).getBoolean("LOGIN_APP_CUSTOMER", false);
		return userLogin;
	}
