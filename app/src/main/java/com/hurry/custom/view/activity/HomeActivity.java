...
//        }
    ...
    public void initNavigation() {
        ...
        if(pageSelection == 2 ){
            homeFragment = pagerAdapter.getItem(pageSelection);
        }
        if(isViewPager){
            showViewPager(-1);
        }else{
                ...
                if(frameLayout.getVisibility() == View.VISIBLE && !Constants.page_type.equals("confirm")
                    ...
                    switch (position){
                        ...
                        case 2:
                            ...
                            homeFragment = pagerAdapter.getItem(2);
...
//                            }
    ...
    public void updateImage(){
        ((HomeFragment)homeFragment).updateImage();
    }
                ...
                new AlertDialog.Builder(HomeActivity.this)
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int whichButton) {
                                ...
                                PreferenceUtils.setFirstStart(HomeActivity.this, false);
                                Constants.orderHisModels.clear();
